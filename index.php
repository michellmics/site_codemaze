				...
				<div class="col-md-6 col-sm-6">
					<div class="right-top">
						<div class="social-box">
							<ul>
								<li><a href="https://www.facebook.com/profile.php?id=61567212358304" target="_blank"><i class="fa fa-facebook-square" aria-hidden="true"></i></a></li>
								<li><a href="https://www.instagram.com/codemaze_" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
								<li><a href="https://www.linkedin.com/company/agencia-codemaze/about/" target="_blank"><i class="fa fa-linkedin-square" aria-hidden="true"></i></a></li>
							<ul>
						</div>
					</div>
				</div>
                    ...
                    <div class="pricingTable">
                        ...
                        <div class="price-value">
                            <div class="value">
                                ...
                                <span class="amount" style="font-size: 30px;">14.<span style="font-size: 27px;">99</span></span>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="widget clearfix">
                        ...
                        Whatsapp: <spam style="color: orange">+55 19 99017-5759</spam><br>
                        Whatsapp: <spam style="color: orange">+55 19 99250-2546</spam><br>
                ...
                <div class="widget clearfix">
                        ...
                        <ul class="footer-links hov">
                            <li><a href="https://codemaze.com.br/admin" target="_blank">Intranet <span class="icon icon-arrow-right2"></span></a></li>
							<li><a href="https://codemaze.com.br/webmail" target="_blank">Webmail <span class="icon icon-arrow-right2"></span></a></li>
							<li><a href="https://dashboard.agency/codemaze" target="_blank">Portal do Cliente <span class="icon icon-arrow-right2"></span></a></li>
                            <li><a href="https://codemaze.com.br/Codemaze_Suporte.exe" target="_blank">Suporte Técnico <span class="icon icon-arrow-right2"></span></a></li>
