        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="#" onclick="loadInIframe('table_agenda.php')"><i class="fa fa-circle-o"></i> Lista de atividades</a></li>
                ...
                <li><a href="#" onclick="loadInIframe('form_publicidade.php')"><i class="fa fa-circle-o"></i> Cadastro de Publicidade</a></li>
              </ul> 
            </li>
            <li class="treeview">
              <a href="#">
