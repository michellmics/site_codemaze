                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td style="text-transform: uppercase; font-size: 12px;"><a href="#" onclick="document.getElementById('form-<?= $client['PRS_IDPRODUTO_SERVICO'] ?>').submit();" target="_blank"><span class="label label-warning">EDITAR</span></a></td>
