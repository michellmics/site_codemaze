...
{
    public function updateAgenda($titulo,$dtinicio,$dtfim,$status,$descricao,$funcionario,$id)
    {
        try {
                    $result = $this->updateAgendaInfo($titulo,$dtinicio,$dtfim,$status,$descricao,$funcionario,$id);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') 
{
    ...
    $result = $registerAgenda->updateAgenda($titulo,$datainiFormatada,$datafimFormatada,$status,$descricao,$funcionario,$id);
}
?>
