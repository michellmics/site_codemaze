...
if (!isset($_SESSION['user_id'])) //não ta passando as variaveis de seção no safari
{
                ...
                <form id="form-empresa" role="form" method="POST">
                  ...
                  <!-- CAMPOS COMO VARIAVEIS -->
                    ...
                    <div class="form-group">
                      ...
                      <textarea id="obs" name="obs"  class="form-control" rows="5" placeholder="Enter ..."><? echo $siteAdmin->ARRAY_PROSPEC_CLIENTESINFO[0]["PRC_DCOBSERVACOES"]; ?></textarea>
                    </div>
      ...
      function confirmAndSubmit(event) {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            $.ajax({
              url: "prospec_proc_edit.php", // URL para processamento
              type: "POST",
              data: formData,
