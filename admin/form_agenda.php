  ...
  <body class="skin-blue">
    <div class="wrapper">
            ...
            <div class="col-md-10">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Cadastro de Atividades</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
      ...
      <div style="flex: 3">
			...
			<input required type="text" style="width: 100%; text-transform: uppercase;" maxlength="50" class="form-control" placeholder="DD/MM/YYYY" id="dtinicio" name="dtinicio"   />
			</div>
      <div style="flex: 1;">
			<label>DATA FIM</label>
      <input required type="text" style="width: 100%; text-transform: uppercase;" maxlength="50" class="form-control" placeholder="DD/MM/YYYY" id="dtfim" name="dtfim"   />
			</div>	
