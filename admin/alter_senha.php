    ...
    <div class="register-box">
        ...
        <div class="register-box-body">
            ...
            <form action="alter_senha_proc.php" method="post" id="formRegistro">
                ...
                <div class="form-group has-feedback">
                    <input type="password" name="novasenha" class="form-control" placeholder="Digite a nova senha" maxlength="20" required/>
                    <span class="glyphicon glyphicon-log-in form-control-feedback"></span>
                </div>

                <div class="form-group has-feedback">
                    <input type="password" name="novasenha_repeat" class="form-control" placeholder="Digite a senha novamente" maxlength="20" required/>
                    <span class="glyphicon glyphicon-log-in form-control-feedback"></span>
                </div>
