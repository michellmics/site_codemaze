                  ...
                  <table class="table table-hover">
                    ...
                    <?php foreach ($dadosPagina as $client): ?>
                      ...
                      <tr style="cursor: pointer;" onclick="window.location.href='https://www.codemaze.com.br/site/admin/form_prospec_edit.php?id=<?= $client['PRC_IDPROSPEC_CLIENTES'] ?>';">
                        ...
                        <td style="text-transform: uppercase; font-size: 15px; vertical-align: middle;"><a <?php echo $linkMaps; ?> onclick="event.stopPropagation(); event.preventDefault();"><span <? echo $classLabelMaps; ?>><i class="fa fa-location-arrow"></i></span></a></td>                  
