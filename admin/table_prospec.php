                    ...
                    <?php foreach ($dadosPagina as $client): ?>
                      <?php 
                        ...
                        if($client['PRC_DCMAPS_END'] != '')
                        {
                          ...
                          $linkMaps = 'href="'.htmlspecialchars($client['PRC_DCMAPS_END']).'" target="_blank" onclick="event.stopPropagation(); event.preventDefault(); window.open(this.href, \'_blank\');"';
                      ...
                      <tr style="cursor: pointer;" onclick="window.location.href='https://www.codemaze.com.br/site/admin/form_prospec_edit.php?id=<?= $client['PRC_IDPROSPEC_CLIENTES'] ?>';">
                        ...
                        <td style="text-transform: uppercase; font-size: 15px; vertical-align: middle;"><a <?php echo $linkMaps; ?>><span <? echo $classLabelMaps; ?>><i class="fa fa-location-arrow"></i></span></a></td>                  
