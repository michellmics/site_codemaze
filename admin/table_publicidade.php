                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td style="text-transform: uppercase; font-size: 15px;"><a href="https://www.codemaze.com.br/site/admin/table_liquidacaoFinanceira.php?table_search=<?= htmlspecialchars($publicidade['GEC_IDGESTAO_CONTRATO']) ?>"><span class="<? echo $icon; ?>"><? echo $result; ?></span></a></td>
