                  ...
                  <table class="table table-hover">
                    ...
                    <tr>
                        <? 
                          ...
                          $boleto = $liquidFin['LFI_PAGSEGURO_LINK_BOLETO'] == NULL ? "<a href='https://www.codemaze.com.br/site/admin/boleto_proc.php?LFI_IDOP=$idOrdemPagamento' target='_self'>Gerar Boleto</a>" : "<a href='$linkBoleto' target='_blank'><i style='width: 20px; height: 20px;' class='fas fa-file-pdf'></i></a>";
