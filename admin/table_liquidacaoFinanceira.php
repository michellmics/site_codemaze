                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td>
			                  <input  type="text" style="width: 52%; text-transform: uppercase;" minlength="10" maxlength="10" class="form-control" placeholder="MM-DD-YYYY" id="pagamento_<?php echo $liquidFin['LFI_IDLIQUIDACAOFINANCEIRA']; ?>" name="pagamento" />
                        </td>                   
